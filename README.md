...
<body>
  ...
  <script>
    ...
    form.addEventListener('submit', function(e) {
      ...
      const now = new Date();
      const jam = now.toLocaleTimeString('id-ID'); // jam:menit:detik
